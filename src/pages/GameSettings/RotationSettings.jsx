    ...
    <>
      ...
      <main className="game-settings-container" aria-labelledby="rotation-settings-title">
        ...
        <div className="section-with-title difficulty-container">
          <span className="section-title">🎯 {t('text.difficulty')}</span>
          <div className="toggle-container">
            <label htmlFor="random-difficulty" className="toggle-label">{t('text.random_difficulty')}</label>
            <Switch
